...
|Epic 1|                                                                                                 |                                                                                                                                                                                   |                                                                                                                                                                                                                                                                                                                                                                                  |                |              |      |
|------|-------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------|--------------|------|
|Isue  |Title                                                                                            |User Story                                                                                                                                                                         |Acceptance Criteria                                                                                                                                                                                                                                                                                                                                                               |Implementatition|Final Commit  |Result|
|#37   |USER STORY: Set up Locally the VS Code IDE                                                       |As a software developer,I can to set up the VS Code IDE on my local machine,so that I can efficiently develop and debug my projects.                                             |The project setup for VS Code involves installing necessary extensions, configuring settings and keybindings, organizing the workspace, integrating Git, setting up debugging tools, and installing essential extensions for linting, formatting, and code analysis.<br>                                                                                                          |N/A             |not applicable|PASS  |
